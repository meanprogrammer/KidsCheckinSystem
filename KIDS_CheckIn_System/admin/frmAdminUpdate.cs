    ...
    public partial class frmAdminUpdate : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (cboSearch.Text == "Barcode")
            {
                ...
                qry = "SELECT k.*,g.fldGender as Gender FROM tblKids  k " +
                             "LEFT OUTER JOIN tblGender g ON g.fldID=k.fldGender" +
                             " WHERE fldStudentID='" + txtSearch.Text.Replace("'", "''") + "' ORDER BY fldFirstName,fldLastName";
                ...
                parse = int.TryParse(js.Lookup("fldUpdateStatus", "tblKids", "fldID='" + fldKidsID + "'"), out status);
                ...
                string picture = js.GetPath() + "/Kids/" + js.RiD["fldPicture"].ToString().Replace("'","''");
                ...
                for (int i = 0; i <= (fetcherID.Length - 1); i++)
                {
                    ...
                    if (js.RiD.HasRows)
                    {
                        dgvFetchers.Rows.Add(js.RiD["fldID"], js.RiD["fldFirstName"], js.RiD["fldLastName"], js.RiD["fldMiddleName"], js.RiD["Relationship"], js.RiD["fldContactNumber"], js.RiD["fldAddress1"], js.RiD["fldAddress2"], js.RiD["fldCity"], js.RiD["fldZipCode"], js.RiD["fldPicture"].ToString().Replace("'","''"));
                    }
                ...
                if (dgvFetchers.Rows.Count != 0)
                {
                    ...
                    {
                        if (System.IO.File.Exists(js.GetPath() + "/Fetchers/" + dgvFetchers.Rows[0].Cells["Picture"].Value.ToString()))
                        {
                            pbFetcher1.Image = Image.FromFile(js.GetPath() + "/Fetchers/" + dgvFetchers.Rows[0].Cells["Picture"].Value.ToString());
                        }
                    }
                    else if (dgvFetchers.Rows.Count == 2)
                    {
                        ...
                        if (System.IO.File.Exists(js.GetPath() + "/Fetchers/" + dgvFetchers.Rows[1].Cells["Picture"].Value.ToString()))
                        {
                            pbFetcher2.Image = Image.FromFile(js.GetPath() + "/Fetchers/" + dgvFetchers.Rows[1].Cells["Picture"].Value.ToString());
                        }
                    }
                    else
                    {
                        ...
                        if (System.IO.File.Exists(js.GetPath() + "/Fetchers/" + dgvFetchers.Rows[2].Cells["Picture"].Value.ToString()))
                        {
                            pbFetcher3.Image = Image.FromFile(js.GetPath() + "/Fetchers/" + dgvFetchers.Rows[2].Cells["Picture"].Value.ToString());
                        }
                    }
                }
            ...
            if (frm.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                try { System.IO.File.Delete(temppic); } catch(Exception ex){}
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if(txtKNFC.Text.Trim()=="")
            {
                MessageBox.Show("Kids NFC Code Required");
                return;
            }
           ...
           string query = "UPDATE tblKids SET fldUpdateStatus=3 WHERE fldID='" + fldKidsID + "'";

           js.ExecuteNonQuery(query);
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i<=(dgvFetchers.Rows.Count-1);i++)
            {
                ...
                //    q = "UPDATE tblFetcherNFC SET fldNFCCode='" + txtFNFC.Text + "' WHERE fldFetcherID='" + fID + "'";
                ...
                //else
                //{
                    q = "INSERT INTO tblFetcherNFC(fldNFCCode,fldFetcherID) VALUES('" + txtFNFC.Text + "','" + fID + "')";
            ...
            try { System.IO.File.Delete(Application.StartupPath + "/Pictures/Kids/tmp1.jpg"); }
            catch(Exception ex){js.showExclamation(ex.Message);}
