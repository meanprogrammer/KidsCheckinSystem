    ...
    public partial class frmOverride : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (CheckCard())
            {
                ...
                if(overrider!="")
                {
                    groupBox1.Text = overrider;
                    lblOverrider.Text = tmpStr;
                }
        ...
        {
            if (lblOverrider.Text != "OVERRIDE CODE")
            {
                DialogResult = System.Windows.Forms.DialogResult.OK;
            }
            else
            {
                lblNotification.Text = "Please Tap your override card";
            }
        }

        private void frmOverride_FormClosed(object sender, FormClosedEventArgs e)
        {
